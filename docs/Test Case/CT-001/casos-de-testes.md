...
### Evidências!
![Entrada](TimeClockSystem/docs/Images/IMG-CT-001/01-entrada.png)

![Início da pausa](TimeClockSystem/docs/Images/IMG-CT-001/02-inicio-pausa.png)

![Fim da pausa](TimeClockSystem/docs/Images/IMG-CT-001/03-fim-pausa.png)

![Negar saída](TimeClockSystem/docs/Images/IMG-CT-001/04-jornada-nao-comprida.png)

![Registros no banco](TimeClockSystem/docs/Images/IMG-CT-001/05-registros.png)